    ...
    <footer className="bg-smoke border-t border-gold/10 mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-ash text-sm">Pedidos via WhatsApp · Frete para todo o Brasil</p>
          <a
          ...
          <a
            ...
            target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-ash text-sm hover:text-gold transition-colors"
          >
            <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-gold/10 py-4 px-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-ash/50">
        <span>© {new Date().getFullYear()} Caballeros Parfum. Todos os direitos reservados.</span>
        <span>Devolução em 7 dias conforme CDC · Produtos 100% originais</span>
      </div>
    </footer>
  )
}
